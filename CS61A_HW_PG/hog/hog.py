...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    tens_digit_opponent = (opponent_score // 10) % 10
    ones_digit_player = player_score % 10
    return max(3 * abs(tens_digit_opponent - ones_digit_player), 1)
    # END PROBLEM 2
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    "*** YOUR CODE HERE ***"
    origin_delta_score = 0
    if num_rolls == 0:
        origin_delta_score = boar_brawl(player_score, opponent_score)
    else:
        origin_delta_score = roll_dice(num_rolls, dice)

    return origin_delta_score
    # END PROBLEM 3
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    return sus_points(take_turn(num_rolls, player_score, opponent_score, dice=six_sided))
    # END PROBLEM 4
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for player_score in range(goal):
        for opponent_score in range(goal):
            if strategy(player_score,opponent_score) != std:
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    for num_rolls in range(10):
        current = make_averaged(roll_dice, times_called=1000)(num_rolls + 1, dice=six_sided)
        if current > maximum:
            maximum,initial_value = current,num_rolls + 1
